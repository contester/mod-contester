...
/// Print the page header
	...
	$sql = "select contester_problems.id as id, contester_problems.name as name,
				   contester_problems.dbid as dbid, contester_problems.description as description,
				   contester_problems.input_format as input, contester_problems.output_format as output
